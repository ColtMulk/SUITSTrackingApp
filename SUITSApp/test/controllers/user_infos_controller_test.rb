...
class UserInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post user_infos_url, params: { user_info: { first_name: @user_info.first_name, last_name: @user_info.last_name, member_status: @user_info.member_status } }
    end
  ...
  test "should update user_info" do
    patch user_info_url(@user_info), params: { user_info: { first_name: @user_info.first_name, last_name: @user_info.last_name, member_status: @user_info.member_status } }
